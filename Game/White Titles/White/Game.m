...
-(void)GameOver
{
    ...
    //ScoreLabel.center = CGPointMake(160, 140);
...
-(void)TimeCowntDown
{
    ...
    TimeLabel.text = [NSString stringWithFormat:@"Time: %.02f",TimeNumber];
...
-(void)TileMoveDown
{
    ...
    if(Row1Tile1.center.y > 500){
        Row1Tile1.center = CGPointMake(Row1Tile1.center.x, -66);
        Row1Tile2.center = CGPointMake(Row1Tile2.center.x, -66);
        Row1Tile3.center = CGPointMake(Row1Tile3.center.x, -66);
        Row1Tile4.center = CGPointMake(Row1Tile4.center.x, -66);
        [self PlaceRow1BlackTile];
    }
    if (Row2Tile1.center.y > 500) {
        Row2Tile1.center = CGPointMake(Row2Tile1.center.x, -66);
        Row2Tile2.center = CGPointMake(Row2Tile2.center.x, -66);
        Row2Tile3.center = CGPointMake(Row2Tile3.center.x, -66);
        Row2Tile4.center = CGPointMake(Row2Tile4.center.x, -66);
        [self PlaceRow2BlackTile];
    }
    if (Row3Tile1.center.y > 500) {
        Row3Tile1.center = CGPointMake(Row3Tile1.center.x, -66);
        Row3Tile2.center = CGPointMake(Row3Tile2.center.x, -66);
        Row3Tile3.center = CGPointMake(Row3Tile3.center.x, -66);
        Row3Tile4.center = CGPointMake(Row3Tile4.center.x, -66);
        [self PlaceRow3BlackTile];
    }
    if (Row4Tile1.center.y > 500) {
        Row4Tile1.center = CGPointMake(Row4Tile1.center.x, -66);
        Row4Tile2.center = CGPointMake(Row4Tile2.center.x, -66);
        Row4Tile3.center = CGPointMake(Row4Tile3.center.x, -66);
        Row4Tile4.center = CGPointMake(Row4Tile4.center.x, -66);
        [self PlaceRow4BlackTile];
    }
    if (Row5Tile1.center.y > 500) {
        Row5Tile1.center = CGPointMake(Row5Tile1.center.x, -66);
        Row5Tile2.center = CGPointMake(Row5Tile2.center.x, -66);
        Row5Tile3.center = CGPointMake(Row5Tile3.center.x, -66);
        Row5Tile4.center = CGPointMake(Row5Tile4.center.x, -66);
...
{
    Timer = [NSTimer scheduledTimerWithTimeInterval:0.01 target:self selector:@selector(TimeCowntDown) userInfo:nil repeats:YES];
